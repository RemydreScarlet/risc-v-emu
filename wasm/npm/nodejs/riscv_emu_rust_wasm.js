...
class WasmRiscv {
     ...
     * @param {number} cycles
     */
    run_cycles_optimized(cycles) {
        wasm.wasmriscv_run_cycles_optimized(this.__wbg_ptr, cycles);
    }
    /**
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./riscv_emu_rust_wasm_bg.js": import0,
    };
}
...
const wasmPath = `${__dirname}/riscv_emu_rust_wasm_bg.wasm`;
